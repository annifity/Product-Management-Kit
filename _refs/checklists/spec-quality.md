...
- Each requirement has a clear actor or system owner.
- Scope boundaries are explicit.
- Business rules are explicit and not hidden inside prose.
- Workflows include success and failure paths.
- State transitions include invalid conditions and stuck-state handling when stateful.
- Permissions and role behavior are defined.
